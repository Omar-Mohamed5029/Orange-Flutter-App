...
class MedtermItem extends StatelessWidget {
  const MedtermItem({Key? key,required this.text,required this.time,required this.ExamDate,required this.StartDate
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    DefaultText(text:time,size: 15,color: Colors.black,)
                  ],
                ),
              ],
            ),
